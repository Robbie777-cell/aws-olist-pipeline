...
def main():
    ...
    wetlands = [
        ...
        {"id":"mallorquin", "nombre":"Cienaga de Mallorquin", "lat":11.045, "lng":-74.835, "descripcion":"Laguna costera norte de Barranquilla. Manglar denso."},
        {"id":"totumo", "nombre":"Cienaga de Totumo", "lat":10.732, "lng":-75.229, "descripcion":"Humedal salobre con volcan de lodo activo."},
        {"id":"zapatosa", "nombre":"Cienaga de Zapatosa", "lat":8.95, "lng":-73.80, "descripcion":"Mayor humedal interior de Colombia (Cesar/Magdalena)."},
        {"id":"caimanera", "nombre":"La Caimanera (Cispata)", "lat":9.37, "lng":-75.78, "descripcion":"Complejo de manglares Cispata, Golfo de Morrosquillo."}
    ]
    resultado = {
        "metadata": {
